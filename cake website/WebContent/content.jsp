	...
	<!--  <div id="cart-info" class="nav-info align-items-center cart-info d-flex justify-content-between mx-lg-5">
	 ...
	 <li>
         ...
         <section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    ...
                    <div class="shop-item-details">
                        <span style="font-size:19px" class="shop-item-price">Rs.599</span>
                ...
                <div class="shop-item">
                    ...
                    <div class="shop-item-details">
                        <span style="font-size:19px" class="shop-item-price"  ><strike>Rs.600</strike></span>
                         <span style="font-size:19px" class="colorchange1">Rs.450</span>
                        <button class="btn btn-primary shop-item-button"type="button">ADD TO CART</button>
                    </div>
                </div>
                <div class="shop-item">
                    ...
                    <div class="shop-item-details">
                        <span style="font-size:19px" class="shop-item-price">Rs.699</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                    </div>
                </div>
           ...
           <!--   <div class="shop-item">
                    <span class="shop-item-title">Archies Sugarfree Belgium Chocolate</span>
                    <img class="shop-item-image" src="img/c9.jpg">
                    <div class="shop-item-details">
                        <span style="font-size:19px" class="shop-item-price">Rs.599</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                    </div>
                ...
                <div class="shop-item">
                    ...
                    <div class="shop-item-details">
                        <span style="font-size:19px" class="shop-item-price">Rs.799</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                    </div>
                </div>
                 ...
                 <div class="shop-item">
                    ...
                    <div class="shop-item-details">
                        <span style="font-size:19px" class="shop-item-price">Rs.499</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                    </div>
                </div>
                 ...
                 <div class="shop-item">
                    ...
                    <div class="shop-item-details">
                      ...
                      <div class="shop-item">
                    <span class="shop-item-title">Messi Cake</span>
                    <img class="shop-item-image" src="img/messi.jpg">
                    <div class="shop-item-details">
                        <span style="font-size:19px" class="shop-item-price">Rs.599</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                      ...
                      <div class="shop-item">
                    <span class="shop-item-title">Archies Rose</span>
                    <img class="shop-item-image" src="img/New Cakes.jpg">
                    <div class="shop-item-details">
                        <span style="font-size:19px" class="shop-item-price">Rs.599</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                      ...
                      <div class="shop-item">
                    <span class="shop-item-title">Silver Jubilee</span>
                    <img class="shop-item-image" src="img/white-silver-delight-9946820ca-A.jpg">
                    <div class="shop-item-details">
                        <span style="font-size:19px" class="shop-item-price">Rs.599</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                      ...
                      <div class="shop-item">
                    <span class="shop-item-title">Kids Special</span>
                    <img class="shop-item-image" src="img/whimsy-airplane-poster-cake-9990010cp-B.jpg">
                    <div class="shop-item-details">
                        <span style="font-size:19px" class="shop-item-price">Rs.599</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                      ...
                      <div class="shop-item">
                    <span class="shop-item-title">Thrilled Choconilla</span>
                    <img class="shop-item-image" src="img/thrilled-choconilla-cake-9954060ca-D (1).jpg">
                    <div class="shop-item-details">
                        <span style="font-size:19px" class="shop-item-price">Rs.599</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                      ...
                      <div class="shop-item">
                    <span class="shop-item-title">Mom Special</span>
                    <img class="shop-item-image" src="img/cake-for-lovely-maa-9944820ca-A.jpg">
                    <div class="shop-item-details">
                        <span style="font-size:19px" class="shop-item-price">Rs.599</span>
                        <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
